...
vjs.options = {
  ...
  // Default of app browser is 300x150. Should rely on source width/height.
  'width': 300,
  'height': 150,
  // defaultVolume: 0.85,
...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // Flash iFrame Mode
    // In app browsers there are multiple instances where changing the parent element or visibility of a plugin causes the plugin to reload.
    ...
    // Even though the iframe was inserted into a page on the app, Firefox + Flash considers it a local app trying to access an internet file.
