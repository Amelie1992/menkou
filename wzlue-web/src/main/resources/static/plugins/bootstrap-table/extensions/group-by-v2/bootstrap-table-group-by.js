    ...
    BootstrapTable.prototype.initBody = function () {
        ...
        if ((this.options.groupBy) && (this.options.groupByField !== '')) {
            ...
            tableGroups.forEach(function(item){
                ...
                html.push(sprintf('<tr class="info groupBy expanded" data-power-index="%s">', item.id));
            ...
            this.$body.find('[name="btSelectGroup"]').each(function() {
                ...
                that.$selectGroup.push({
                    ...
                    item: that.$selectItem.filter(function () {
                        ...
                        self.closest('tr').data('power-index'));
                    })
                });
            });
            ...
            this.$container.off('click', '.groupBy')
                .on('click', '.groupBy', function() {
                    ...
                    that.$body.find('tr[data-parent-index='+$(this).closest('tr').data('power-index')+']').toggleClass('hidden');
                });
            ...
            this.$container.off('click', '[name="btSelectGroup"]')
                .on('click', '[name="btSelectGroup"]', function (event) {
                    ...
                    that[checked ? 'checkGroup' : 'uncheckGroup']($(this).closest('tr').data('power-index'));
                });
        }
